...
?>
      ...
      <footer class="footer">
          <ul class="footer-links">
              <li class="footer-links__item"><a href="#">Qui sommes nous? </a></li>
              <li class="footer-links__item"><a href="#">Blog</a></li>
              <li class="footer-links__item"><a target="_blank" href="https://www.facebook.com/EchoTri-545067608842775/">Facebook</a></li>
              <li class="footer-links__item">EchoTri tous droits reservés 2015</li>
          </ul>
      </footer>

    </main>

	<!-- <section class="full-cd-modal"></section> -->
    ...
    <div class="cd-modal" data-modal="modal-trigger" ng-controller="ModalCtrl">
        ...
        <a href="#" class="modal-close" title="Fermer">
            <span class="icon-elt" ng-click="closeModal($event)">
                <svg class="icon"><use xlink:href="images/svg/svg-defs.svg#shapes-close" /></svg>
            </span>
        </a>
    </div> <!-- cd-modal -->
